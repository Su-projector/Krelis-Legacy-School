...
const socialLinks = [
    { href: 'https://wa.me/2341234567890', label: 'WhatsApp', icon: 'whatsapp' },
    { href: 'mailto:info@krelislegacy.edu', label: 'Email', icon: 'email' },
    { href: 'tel:+23401234567890', label: 'Phone', icon: 'phone' },
];
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-sm">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <p className="text-gray-300">info@krelislegacy.edu</p>
                            </div>
                        </div>
                    </div>
                </div>
